class Form {
  ...
  display(){
    ...
    this.button1.position(displayWidth / 2 - 60, displayHeight / 2 - 60);
    this.button2.position(displayWidth / 2 + 60, displayHeight / 2 - 60);
    this.button3.position(displayWidth / 2 - 60, displayHeight / 2 + 60);
    this.button4.position(displayWidth / 2 + 60, displayHeight / 2 + 60);

    this.back.position(displayWidth / 2, displayHeight / 2 + 400);
...
badmintonContent() {
  ...
  this.greeting.position(displayWidth / 2 - 600, displayHeight / 10);
} 
...
cricketContent(){
  ...
  this.greeting.position(displayWidth / 2 - 600, displayHeight / 15);
}
...
basketballContent(){
  ...
  this.greeting.position(displayWidth / 2 - 600, displayHeight / 20);
